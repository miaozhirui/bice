...
/******/ 	__webpack_require__.p = "/resource/build/";
/******/
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open '/Users/mzr/credan/bice_cms/node_modules/hdjs/dist/hdjs.js'");
...
var _ucenter = __webpack_require__(32);

var _ucenter2 = _interopRequireDefault(_ucenter);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_vue2.default.use(_vuex2.default);
exports.default = new _vuex2.default.Store({
    modules: { ucenter: _ucenter2.default }
});
...
var _hdjs = __webpack_require__(3);

var _hdjs2 = _interopRequireDefault(_hdjs);

var _hdcms = __webpack_require__(33);

var _hdcms2 = _interopRequireDefault(_hdcms);
...
exports.default = {
    ...
    state: {
        ...
        modules: window.modules && window.modules.head ? window.modules : {
            head: { isshow: true, "title": "会员中心", "bgimg": __webpack_require__(35), "thumb": "", "description": "", "keyword": "" }
        },
        //个人中心扩展菜单
        menus: window.menus
    },
    ...
    mutations: {
        //设置组件变量
        set: function set(state, component, field, value) {
            state['modules'][component][field] = value;
        },
        //添加菜单
        addMenu: function addMenu(state) {
            var menu = {
                name: '',
                url: '',
                status: 1,
        ...
        //图标选择
        font: function font(state, item) {
            _hdjs2.default.font(function (icon) {
                item.css.icon = icon;
            });
        },

        //系统链接
        systemLink: function systemLink(state, item) {
            _link2.default.system(function (url) {
                item.url = url;
            });
        }
    },
...
/*
 ...
 |--------------------------------------------------------------------------
 */
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (hdjs) {
    return {
        /**
         * 选择目录或文件
         * @param callback
         */
        selectFile: function selectFile(callback) {
         ...
         * 更新站点缓存
         */
        updateSiteCache: function updateSiteCache() {
         ...
         */
        getUsers: function getUsers(callback, filterUid) {
            //站点编号
         ...
         * @param object opt 选项
         */
        getModuleTemplate: function getModuleTemplate(callback, opt) {
            var options = $.extend({
                module: [],
                template: []
            }, opt);
         ...
         */
        moduleBrowser: function moduleBrowser(callback, mid, type) {
         ...
         * @param mid 已经使用的模块如 1,2,3以逗号分隔
         */
        getModuleHasWebPage: function getModuleHasWebPage(callback, mid) {
            var modalobj = hdjs.modal({
         ...
         * @param callback
         */
        siteTemplateBrowser: function siteTemplateBrowser(callback) {
            var modalobj = hdjs.modal({
         ...
         */
        checkWxKeyword: function checkWxKeyword(content, rid, callback) {
            if (content == '') return;
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (hdjs) {
    return {
         ...
         * @param callback
         */
        system: function system(callback) {
            var modalobj = hdjs.modal({
...
module.exports = __webpack_require__.p + "images/a59b91b22c6904b4f373b9046292590e.jpg";
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open '/Users/mzr/credan/bice_cms/node_modules/lodash/lodash.js'");
